...
export const metadata: Metadata = {
  ...
  description: "A modern, minimalist portfolio template for digital artists with neon aesthetics.",
  keywords: ["art", "digital art", "portfolio", "template", "synthwave", "cyberpunk", "next.js"],
